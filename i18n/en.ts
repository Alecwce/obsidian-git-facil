...
export const en: Record<TranslationKeys, string> = {
	...
	ghMissing:
		"⚠️ gh not installed (optional): https://cli.github.com — you can also paste the URL manually",
	ghNotLogged:
		"⚠️ gh not logged in: run `gh auth login` in your terminal — or use a manual token below",
	createRepoTitle: "Or create a new GitHub repository",
	createRepoNamePlaceholder: "repo-name",
	createRepoPrivate: "Private (recommended)",
	createRepoBtn: "Create repo & push",
	createRepoCreating: "Creating repository...",
	tokenTitle: "Or use a manual GitHub token",
	tokenDesc:
		"Stored in plain text inside the plugin folder. Create a token with the minimal repo scope and revoke it if exposed.",
	tokenPlaceholder: "ghp_...",
	tokenVerifyBtn: "Verify & save",
	tokenClearBtn: "Clear token",
	tokenVerifying: "Verifying...",
	tokenSavedOk: "✅ Valid token ({login}), saved",
	tokenInvalid: "❌ Invalid token or no access",
	tokenCleared: "Token cleared",
	tokenSaved: "✅ Token saved (hidden for security)",
